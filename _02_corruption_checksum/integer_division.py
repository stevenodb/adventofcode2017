...
is some information about the evenly divisible values in the
spreadsheet. Unfortunately, none of us are equipped for that
...
with open('input') as f:
    for line in f:
        row = [int(value) for value in line.split(sep='\t')]
        div_sum += possible_division(row)
